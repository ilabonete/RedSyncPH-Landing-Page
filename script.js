...
document.getElementById('downloadBtn').addEventListener('click', function(e) {
    ...
    setTimeout(() => {
        ...
        // Check if APK file exists, otherwise show instructions
        const apkUrl = './assets/RedSync-PH.apk'; // You can place your APK file here
        
        // Create a download link
        const downloadLink = document.createElement('a');
        downloadLink.href = apkUrl;
        downloadLink.download = 'RedSync-PH.apk';
        downloadLink.style.display = 'none';
        
        // Try to download, if file doesn't exist, show alternative
        fetch(apkUrl, { method: 'HEAD' })
            ...
            .catch(() => {
                // Network error or file doesn't exist, show instructions
                showDownloadInstructions();
            });
    }, 1500);
});

// Hero Download Button Functionality
document.addEventListener('DOMContentLoaded', function() {
...
// Function to show download instructions when APK is not available
    ...
    modal.innerHTML = `
        <div class="modal-content">
            <div class="modal-header">
                <h3><i class="fas fa-download"></i> RedSync PH APK Download</h3>
            ...
            <div class="modal-body">
                <div class="download-info">
                    ...
                    <h4>RedSync PH Mobile Application</h4>
                    <p>Contact the development team to get access to the latest APK file:</p>
                    
                    <div class="contact-options">
                        <div class="contact-item">
                            <i class="fas fa-envelope"></i>
                            <span>Email: redsync.ph@gmail.com</span>
                        </div>
                        <div class="contact-item">
                            <i class="fas fa-users"></i>
                            <span>HAnD Partnership Available</span>
                        </div>
                        <div class="contact-item">
